    ...
    <div className='space-y-8'>
      <div className='flex items-center gap-4'>
        ...
        <div className='flex flex-1 flex-wrap items-center justify-between'>
          ...
          <div className='font-medium'>+RM 1,999.00</div>
        </div>
      </div>
      <div className='flex items-center gap-4'>
        ...
        <div className='flex flex-1 flex-wrap items-center justify-between'>
          ...
          <div className='font-medium'>+RM 39.00</div>
        </div>
      </div>
      <div className='flex items-center gap-4'>
        <Avatar className='h-9 w-9'>
        ...
        <div className='flex flex-1 flex-wrap items-center justify-between'>
          ...
          <div className='font-medium'>+RM 299.00</div>
        </div>
      </div>
      ...
      <div className='flex items-center gap-4'>
        ...
        <div className='flex flex-1 flex-wrap items-center justify-between'>
          ...
          <div className='font-medium'>+RM 99.00</div>
        </div>
      </div>
